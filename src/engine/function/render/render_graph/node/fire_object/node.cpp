...
void FireObject::createPipeline(Configuration& cfg)
{
...

    {
        ...
        auto vertShaderCode = readFile(cfg.shader_directory + "/fire_object/node.vert.spv");
        auto fragShaderCode = readFile(cfg.shader_directory + "/fire_object/node.frag.spv");
